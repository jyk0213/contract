...
contract ttying{
    ...
    {
        return (ledger[customer].chunked , profits(customer), ledger[customer].balance, ledger[customer].fromtime,SafeMath.mod(5,3));
    }
        ...
        internal
    {
        ...
        uint256 day = SafeMath.div(diff , circle);
        ...
        emit onLiquid(customer, chunk, ledger[customer].fromtime); // todo
    }
